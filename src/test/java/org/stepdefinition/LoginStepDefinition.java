...
public class LoginStepDefinition extends CommonActions {
	...
	public void user_enter_username_and_password_as(String uname, String passwd) throws InterruptedException {
	...
	public void click_on_Login_button_and_verfies_url() {
